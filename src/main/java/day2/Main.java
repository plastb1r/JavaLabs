    ...
    public static void main(String[] args) {
       ...
       // Comparator<Person> pcomp = new PersonNameComparator();
        ...
        Person person4 = new Person(4, "Мария", "Враночева",
                "женщина", new DateTime(1994, 8, 7, 0, 0));
        Person person5 = new Person(5, "Мария", "Враночева",
                "женщина", new DateTime(1980, 8, 7, 0, 0));
        Person person6 = new Person(6, "Сергей", "Враночев",
                "мужчина", new DateTime(1981, 8, 7, 0, 0));
        Person person7 = new Person(7, "Сергей", "Враночев",
                "мужчина", new DateTime(1982, 8, 7, 0, 0));
        ...
        Person newPerson = new Person(8, "Михаил", "Враночев",
                "мужчина", new DateTime(1982, 8, 7, 0, 0));
